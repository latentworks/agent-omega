...
checksum alongside the app source; presence alone is not compatibility proof. Current releases
publish native engine assets for Windows x64, Linux x64/arm64, and macOS Intel/Apple Silicon from the
