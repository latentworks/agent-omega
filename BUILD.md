...
checksum alongside the app source; presence alone is not compatibility proof. The v2.7.2 release
will publish native engine assets for Windows x64, Linux x64/arm64, and macOS Intel/Apple Silicon from the
