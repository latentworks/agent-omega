...
- Download **`opencode-windows-x64.exe`** and **`SHA256SUMS-omega-v2.7.1.txt`** from the [Agent Omega engine v2.7.1 release](https://github.com/latentworks/opencode-omega/releases/tag/omega-v2.7.1). Rename the binary to `opencode.exe`. This exact forked engine is required; upstream opencode and earlier Agent Omega engines are intentionally rejected at startup.
