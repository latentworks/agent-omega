...
Provide the Linux engine with one of these options:
...
The launcher starts `sidecar.mjs`, creates `~/.agent-omega/workspace`, generates a local WebSocket token, and opens:
