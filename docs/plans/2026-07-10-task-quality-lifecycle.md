...
**Status:** implemented; v2.6.0 release approved on 2026-07-10. Publication requires the matching Windows engine asset, checksum, privacy scrub, and CI verification.
